...
file_path = "c:\\Users\\Familia Smirelli\\OneDrive\\Área de Trabalho\\Empresa Yago\\Escola Futebol\\escolaFut.html"

with open(file_path, "r", encoding="utf-8", errors="ignore") as f:
    content = f.read()

# I want to truncate everything from "<!-- Coach Staff Section -->"
idx = content.find("<!-- Coach Staff Section -->")
if idx != -1:
    content = content[:idx]

new_part = """    <!-- Coach Staff Section -->
